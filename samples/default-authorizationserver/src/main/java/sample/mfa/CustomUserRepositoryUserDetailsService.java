...
public class CustomUserRepositoryUserDetailsService implements UserDetailsService {
	...
	private final sample.mfa.CustomUserRepository userRepository;

	public CustomUserRepositoryUserDetailsService(sample.mfa.CustomUserRepository userRepository) {
