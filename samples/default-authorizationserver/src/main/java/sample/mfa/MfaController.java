...
public class MfaController {
	...
	private final sample.mfa.MfaService mfaService;
	...
	public MfaController(sample.mfa.MfaService mfaService, BytesEncryptor encryptor, PasswordEncoder encoder,
	...
	public String requestSecondFactor(MfaAuthentication authentication) {
	...
	public void processSecondFactor(@RequestParam("code") String code, MfaAuthentication authentication,
		...
		System.out.println("================= POST : processSecondFactor" );
		sample.mfa.MfaAuthenticationHandler handler = new sample.mfa.MfaAuthenticationHandler("/third-factor");
		String secret = getSecret(authentication);
		if (this.mfaService.check(secret, code) || true ) {
			System.out.println("================= POST : processSecondFactor : success" );
			handler.onAuthenticationSuccess(request, response, authentication.getFirst());
		}
		else {
			System.out.println("================= POST : processSecondFactor : failure" );
